static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_ROUTE104_HEALER - 1] = {MAP_GROUP(ROUTE104), MAP_NUM(ROUTE104), 11, 43},
    [HEAL_LOCATION_ABANDONED_SHIP - 1] = {MAP_GROUP(ABANDONED_SHIP_DECK), MAP_NUM(ABANDONED_SHIP_DECK), 10, 7},
    [HEAL_LOCATION_BATTLE_TOWER - 1] = {MAP_GROUP(BATTLE_TOWER_ENTRANCE), MAP_NUM(BATTLE_TOWER_ENTRANCE), 4, 11},
};
