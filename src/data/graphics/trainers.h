...
const u8 gTrainerBackPic_Test[] = INCBIN_U8("graphics/trainers/back_pics/Test.4bpp");
const u32 gTrainerPalette_Test[] = INCBIN_U32("graphics/trainers/back_pics/Test.gbapal.lz");
...
const u32 gTrainerFrontPic_Ty[] = INCBIN_U32("graphics/trainers/front_pics/ty_battle.4bpp.lz");
const u32 gTrainerPalette_Ty[] = INCBIN_U32("graphics/trainers/front_pics/ty_battle.gbapal.lz");

const u32 gTrainerFrontPic_Samir[] = INCBIN_U32("graphics/trainers/front_pics/samir_battle.4bpp.lz");
const u32 gTrainerPalette_Samir[] = INCBIN_U32("graphics/trainers/front_pics/samir_battle.gbapal.lz");

const u32 gTrainerFrontPic_Sugi[] = INCBIN_U32("graphics/trainers/front_pics/sugi_battle.4bpp.lz");
const u32 gTrainerPalette_Sugi[] = INCBIN_U32("graphics/trainers/front_pics/sugi_battle.gbapal.lz");

const u32 gTrainerFrontPic_Aabhash[] = INCBIN_U32("graphics/trainers/front_pics/Aabhash_battle.4bpp.lz");
const u32 gTrainerPalette_Aabhash[] = INCBIN_U32("graphics/trainers/front_pics/Aabhash_battle.gbapal.lz");
...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TY, Ty),
    TRAINER_SPRITE(SAMIR, Samir),
...
const struct SpriteFrameImage gTrainerBackPicTable_Test[] =
{
    {gTrainerBackPic_Test + TRAINER_PIC_SIZE * 0, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Test + TRAINER_PIC_SIZE * 1, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Test + TRAINER_PIC_SIZE * 2, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Test + TRAINER_PIC_SIZE * 3, TRAINER_PIC_SIZE},
};
...
const struct TrainerBacksprite gTrainerBacksprites[] =
{
    ...
    TRAINER_BACK_SPRITE(TEST, 4, Test, Palette_Test, Hoenn),
};
