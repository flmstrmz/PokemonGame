...
// Medicine
    ...
    {
        .name = _("Hyper Potion"),
        .price = (I_PRICE >= GEN_2 && I_PRICE <= GEN_6) ? 1300 : 1500,
        .holdEffectParam = 120,
        .description = COMPOUND_STRING(
            "Restores the HP of\n"
            "a Pokémon by\n"
    ...
    {
        .name = _("Awakening"),
        .price = (I_PRICE >= GEN_2 && I_PRICE <= GEN_6) ? 350 : ((I_PRICE == GEN_7) ? 300 : 300),
        .description = COMPOUND_STRING(
            "Awakens a sleeping\n"
            "Pokémon."),
        .pocket = POCKET_ITEMS,
...
// Ability Modifiers
    ...
    [ITEM_ABILITY_CAPSULE] =
    {
        ...
        .price = (I_PRICE < GEN_7) ? 1000 : ((I_PRICE < GEN_9) ? 5000 : 5000),
        .holdEffectParam = 0,
        .description = COMPOUND_STRING(
            "Switches a Poké-\n"
            "mon's ability."),
...
// Berries
    ...
    [ITEM_POMEG_BERRY] =
    {
        ...
        .price = (I_BERRY_PRICE >= GEN_8) ? 500 : 500,
        .description = COMPOUND_STRING(
            "Makes a Pokémon\n"
            "friendly but lowers\n"
            "base HP."),
...
// TMs/HMs. They don't have a set flingPower, as that's handled by GetFlingPowerFromItemId.
    ...
    [ITEM_TM_SECRET_SWORD] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_SECRET_SWORD, // Todo
    },
    ...
    [ITEM_TM_KARATE_CHOP] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_KARATE_CHOP, // Todo
    },
    ...
    [ITEM_TM_DRAGON_BREATH] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_DRAGON_BREATH, // Todo
    },
    ...
    [ITEM_TM_MYSTICAL_POWER] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_MYSTICAL_POWER, // Todo
    },
    ...
    [ITEM_TM_POISON_FANG] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_POISON_FANG, // Todo
    },
