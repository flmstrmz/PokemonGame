...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_ROUTE_104] = {MAP_GROUP(ROUTE104), MAP_NUM(ROUTE104), HEAL_LOCATION_ROUTE104_HEALER},
    [MAPSEC_ABANDONED_SHIP] = {MAP_GROUP(ABANDONED_SHIP_DECK), MAP_NUM(ABANDONED_SHIP_DECK), HEAL_LOCATION_ABANDONED_SHIP},
    [MAPSEC_BATTLE_TOWER] = {MAP_GROUP(BATTLE_TOWER_ENTRANCE), MAP_NUM(BATTLE_TOWER_ENTRANCE), HEAL_LOCATION_BATTLE_TOWER},
