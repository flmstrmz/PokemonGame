...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    TRAINER_CLASS(COOLTRAINER, "COOLTRAINER", 16, ITEM_ULTRA_BALL),
    TRAINER_CLASS(BIRD_KEEPER, "BIRD KEEPER", 10),
    TRAINER_CLASS(COLLECTOR, "COLLECTOR", 15, ITEM_PREMIER_BALL),
    TRAINER_CLASS(SWIMMER_M, "SWIMMER♂", 7, ITEM_DIVE_BALL),
    TRAINER_CLASS(TEAM_MAGMA, "TEAM MAGMA"),
    TRAINER_CLASS(EXPERT, "EXPERT", 15),
    TRAINER_CLASS(AQUA_ADMIN, "AQUA ADMIN", 20),
    TRAINER_CLASS(BLACK_BELT, "BLACK BELT", 8, ITEM_ULTRA_BALL),
    TRAINER_CLASS(AQUA_LEADER, "AQUA LEADER", 30, ITEM_MASTER_BALL),
    ...
    TRAINER_CLASS(TY, "God Complex", 25),
    TRAINER_CLASS(SAMIR, "Cat Commander", 25),
    TRAINER_CLASS(SUGI, "Jisoo Stan", 25),
    TRAINER_CLASS(AABHASH, "Goth Mommy", 25),
    TRAINER_CLASS(MIRO, "The Tussler", 25),
    TRAINER_CLASS(KRILL, "The Great Dane", 40),
    TRAINER_CLASS(ACE, "Ace Trainer", 20),
    TRAINER_CLASS(MEGA, "MEGA Trainer", 35),
};
